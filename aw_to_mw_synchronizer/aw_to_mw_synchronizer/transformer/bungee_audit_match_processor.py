...
class BungeeAuditMatchProcessor:
    ...
    def fetch_matches_matches(bungee_successful_audit_matches, bungee_unsuccessful_audit_matches):
        
    
    def process(self, bungee_successful_audit_matches, bungee_unsuccessful_audit_matches):
        self.fetch_matches_matches(bungee_successful_audit_matches, bungee_unsuccessful_audit_matches)
